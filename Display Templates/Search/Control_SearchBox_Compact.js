...
,'                        <img src="', $urlHtmlEncodeString(imagesUrl) ,'" class="ms-srch-sb-navImg" id="navImg" alt="', $htmlEncode(Srch.Res.sb_GoNav) ,'" />'
,'                    </a>'
); 
                }
ms_outHtml.push(''
...
,'					<img src="', $urlHtmlEncodeString(imagesUrl) ,'" class="ms-srch-sb-searchImg" id="searchImg" alt="', $htmlEncode(Srch.Res.sb_GoSearch) ,'" />'
,'                </a>'
); 

...
,'                            <img class="', $htmlEncode(previousPageImageClassName) ,'" alt="', $htmlEncode(firstPage.title) ,'" src="', $urlHtmlEncodeString(GetThemedImageUrl('spcommon.png')) ,'" />'
,'                        </span>'
,'                    </a>'
...
,'                        <span class="ms-promlink-button-image">'
,'                            <img class="', $htmlEncode(nextPageImageClassName) ,'" alt="', $htmlEncode(lastPage.title) ,'" src="', $urlHtmlEncodeString(GetThemedImageUrl('spcommon.png')) ,'" />'
,'                        </span>'
,'                    </a>'
,'                </span>'
,'            </li>'

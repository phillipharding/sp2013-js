...
if(ctx.ClientControl.get_showResultCount() && totalRows > 0) {
    if(!showPaging && totalRows > itemsPerPage)
	{
ms_outHtml.push(''
,'        <span class="ms-srch-resultscount" id="Span1">'
,'            ', String.format($htmlEncode(Srch.Res.rs_EdiscoveryTopResultCount), $htmlEncode(totalRows.localeFormat("N0")), $htmlEncode(itemsPerPage)) ,''
,'        </span>'
); 
	}
	else

...
,''
		...
		if(!$isNull(ctx.CurrentItem) && !$isNull(ctx.ClientControl)){
			...
			{
				iconURL = $urlHtmlEncodeString(Srch.U.getIconUrlByFileExtension(ctx.CurrentItem));
...
,'							<a id="ReportLink" href="', $urlHtmlEncodeString(excellink) ,'">', $htmlEncode($resource('tprprt_excel_report_entrypoint')) ,'</a>'
,'						</div>'
);
			}
ms_outHtml.push(''

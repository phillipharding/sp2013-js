...
,'                            <img src="', $urlHtmlEncodeString(SP.Utilities.VersionUtility.getImageUrl(Srch.SU.closeImage)) ,'" />'
,'                        </a>'
,'                    </div>'
...
ms_outHtml.push('                        '
,'                            <a id="', titleId ,'" title="', $htmlEncode(ctx.CurrentItem.Title) ,'" href="', $urlHtmlEncodeString(ctx.CurrentItem.Path) ,'">'

...
{ULSc51:;
    ...
    var submitTag = Discovery.Refiners.createSpecifyOtherSubmitTag(container, $getClientControl(anchorElement));
...
,'        ', ctx.RenderBody(ctx) ,''
    ...
    if(anyResults || ctx.ClientControl.get_hideApplyForMultiValueFilter())
    { 
